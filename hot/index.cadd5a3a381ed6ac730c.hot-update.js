...
const Docs = () => {
  ...
  console.log(parentDocs, filter);
  const handleChange = event => {
    setSearchValue(event.target.value);
    const docs = filteredDocs.filter(doc => doc?.title?.rendered.toLowerCase().includes(searchValue.toLowerCase()));
    setFilteredDocs({
      ...docs
    });
  };
...
_s(Docs, "WufaGRWsvkmmvXWAu7LsI2vssMc=", false, function () {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("ea55647156bb5d33e856")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=index.cadd5a3a381ed6ac730c.hot-update.js.map