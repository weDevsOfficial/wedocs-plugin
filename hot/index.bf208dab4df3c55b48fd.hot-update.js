...
const SettingsPage = () => {
  ...
  const sections = (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_3__.useSelect)(select => {
    return select(_data_docs__WEBPACK_IMPORTED_MODULE_6__["default"]).getSectionsDocs(parseInt(6));
  }, []);
  console.log(parentDocs, sections);
...
_s(SettingsPage, "8ADQIf3n55ThAbNmant75HjUlxU=", false, function () {
  return [_wordpress_data__WEBPACK_IMPORTED_MODULE_3__.useSelect, _wordpress_data__WEBPACK_IMPORTED_MODULE_3__.useSelect, _wordpress_data__WEBPACK_IMPORTED_MODULE_3__.useSelect];
});
_c = SettingsPage;
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("79c6371d5f43c8e4e7d2")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=index.bf208dab4df3c55b48fd.hot-update.js.map