...
const AddArticleModal = _ref => {
  ...
  const [sectionId, setSectionId] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)(defaultSection?.id || '');
  ...
  return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Fragment, null, (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("button", {
    ...
    required: true,
    className: `${formError.title ? '!border-red-500 focus:ring-red-500 focus:border-red-500' : '!border-gray-300 focus:ring-blue-500 focus:border-blue-500'}
  ...
  }), formError.title && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_heroicons_react_20_solid__WEBPACK_IMPORTED_MODULE_8__, {
    className: "h-5 w-5 text-red-500 pointer-events-none absolute inset-y-0 right-0 flex items-center pr-3",
    "aria-hidden": "true"
...
_s(AddArticleModal, "6GPhbGcdxFjVzACkEvMKEbokchY=");
_c = AddArticleModal;
...
const ComboBox = _ref => {
  ...
  }), isFormError ? (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_heroicons_react_20_solid__WEBPACK_IMPORTED_MODULE_6__, {
    className: "h-5 w-5 text-red-500 pointer-events-none absolute inset-y-0 right-0 flex items-center pr-3",
    "aria-hidden": "true"
...
_s(ComboBox, "kP7y1VxbEUEcm4Oqy8f51M0Wb28=", false, function () {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("bc233299e71fc54623a4")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=index.9526144e18a571e051f3.hot-update.js.map