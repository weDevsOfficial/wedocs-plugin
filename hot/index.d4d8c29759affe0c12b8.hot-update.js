...
const AddArticleModal = _ref => {
  ...
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useEffect)(() => {
    setFormError({
      ...formError,
      title: newArticle.title.raw ? false : true
    });
  ...
  }), console.log(formError), formError.title && (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
...
_s(AddArticleModal, "w6SFbjtxYAutoNF2Dsve+UTCLBg=");
_c = AddArticleModal;
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("f1d7d34f4cc473fcfd32")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=index.d4d8c29759affe0c12b8.hot-update.js.map