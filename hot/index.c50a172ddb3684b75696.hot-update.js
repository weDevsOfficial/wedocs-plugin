...
const Docs = () => {
  ...
  const [filteredDocs, setFilteredDocs] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.useState)({
    ...parentDocs
  });
  const handleChange = event => {
    const filteredDocs = filteredDocs.filter(doc => doc?.title?.rendered.toLowerCase().includes(searchValue.toLowerCase()));
    setFilteredDocs({
      ...filteredDocs
    });
  };
  ...
  }), (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)(`Add doc`, 'wedocs')))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_SearchFilter__WEBPACK_IMPORTED_MODULE_7__["default"], null)), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    role: "list",
...
_s(Docs, "MMps+fCdih3crAuvhDAOwThgPIY=", false, function () {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("843e3fa7ff1a9a8d7115")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=index.c50a172ddb3684b75696.hot-update.js.map