...
const SectionArticles = _ref => {
  ...
  const formattedDateString = () => {
    ...
    //     options = { day: "numeric", month: "short", year: "numeric", dayPeriod: "long" };

    let dates = new Date("2022-08-27");
    ...
    let formattedDate = dates.toLocaleDateString("en-US", optionss);
    let dayOfMonth = dates.getDate();
    let ordinal = formatter.format(dayOfMonth, "day");
    console.log(`${ordinal} ${formattedDate}`);
  ...
  }, (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Updated at 27th Aug, 2022', 'wedocs-pro'), (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.sprintf)((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_2__.__)('Updated at %s', 'wedocs'), formattedDateString))))), (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("ff5d727c333d3f3dc912")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=index.8bea9a9cb2914ba7642c.hot-update.js.map