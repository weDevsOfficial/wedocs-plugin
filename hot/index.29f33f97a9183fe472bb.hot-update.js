...
const Docs = () => {
  ...
  // const [ filteredDocs, setFilteredDocs ] = useState( [ ...parentDocs ] );

  // console.log( parentDocs, filteredDocs, searchValue );

  const handleChange = event => {
    setSearchValue(event.target.value);
    // const getDocs = filteredDocs.filter( doc =>
  ...
  const filteredDocs = parentDocs?.filter(doc => doc.name.toLowerCase().includes(searchValue.toLowerCase()));

  // useEffect( () => {
  //     setFilteredDocs( [ ...parentDocs ] );
  // }, [ parentDocs ] );
...
/******/ (() => {
/******/ 	__webpack_require__.h = () => ("55e259e936a1391e0ca1")
/******/ })();
/******/ 
/******/ }
);
//# sourceMappingURL=index.29f33f97a9183fe472bb.hot-update.js.map