...
$wedocs_docs_grid_render = plugin_dir_path( __FILE__ ) . 'assets/build/blocks/DocsGrid/render.php';
if ( file_exists( $wedocs_docs_grid_render ) ) {
    require_once $wedocs_docs_grid_render;
}
