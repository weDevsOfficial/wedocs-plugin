  ...
  return (
    <aside className="py-6 px-2 sm:px-6 lg:py-0 lg:px-0 lg:col-span-3">
      <nav className="py-[18px] bg-white rounded-md space-y-0.5">
        <a
          href="general"
          className="text-gray-600 hover:text-gray-600 hover:bg-gray-100 group rounded-md mx-2 px-5 py-3 flex items-center text-sm font-medium !shadow-none"
        >
          <svg
          ...
          <span className="truncate">{ __( 'General', 'wedocs' ) }</span>
        </a>
        <a
          href="permission"
          className="bg-gray-100 text-gray-900 hover:bg-white group rounded-md mx-2 px-5 py-3 flex items-center text-sm font-medium !shadow-none"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="20"
        ...
        <a
          href="widget"
          className="text-gray-600 hover:text-gray-900 hover:bg-gray-100 group rounded-md mx-2 px-5 py-3 flex items-center text-sm font-medium !shadow-none"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 20 18"
        ...
        >
          ...
          <span className="truncate">{ ( 'License', 'wedocs' ) }</span>
        </a>
      </nav>
    </aside>
  );
