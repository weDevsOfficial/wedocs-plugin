                ...
                <div className="border-l-4 border-indigo-600 rounded-md bg-white p-4 mb-7">
                    <div className="flex space-x-8">
                        <div className="flex flex-shrink-0 relative items-center">
                            <InformationCircleIcon className="h-5 w-5 mt-0.5 text-indigo-600 bg-white absolute -right-1 -top-1 rounded-full z-10" aria-hidden="true" />
                            <div className="avatar">
                                <div className="w-24 h-24 mask mask-squircle">
                                    <img src="https://ps.w.org/wedocs/assets/icon-256x256.png?rev=2281297" alt="" />
                                </div>
                            </div>
                        </div>
                        <div className="ml-3 w-full">
                            <div className="flex justify-between items-center">
                                <h3 className="text-base font-semibold">{ __( 'Run WeDocs Upgrader', 'wedocs' ) }</h3>
                                <svg xmlns="http://www.w3.org/2000/svg" onClick={ () => setShowUpgrader( false ) } fill="#4F46E5" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor" className="w-6 h-6 text-white cursor-pointer">
                                    <path
                                        strokeLinecap="round"
                            ...
                            <div className="mt-2 text-base">
                                <p>{ __( 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquid pariatur, ipsum similique veniam.', 'wedocs' ) }</p>
                            </div>
                            <div className="mt-4">
