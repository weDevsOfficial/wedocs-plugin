    ...
    <Fragment>
      ...
      <Transition appear show={ isOpen } as={ Fragment }>
        <Dialog as="div" className="wedocs-document wedocs-relative wedocs-z-[9999]" onClose={ closeModal }>
          ...
          >
            <div className="wedocs-fixed wedocs-inset-0 wedocs-bg-black wedocs-bg-opacity-25 wedocs-z-[50]"></div>
          </Transition.Child>

          <div className="wedocs-fixed wedocs-inset-0 wedocs-overflow-y-auto wedocs-z-[100]">
            <div className="wedocs-flex wedocs-min-h-full wedocs-items-center wedocs-justify-center wedocs-p-4 wedocs-text-center wedocs-z-[9999]">
              <Transition.Child
                as={ Fragment }
                enter="wedocs-ease-out wedocs-duration-300"
              ...
              >
                <Dialog.Panel className="wedocs-w-full wedocs-max-w-md wedocs-transform wedocs-rounded-2xl wedocs-bg-white wedocs-py-6 wedocs-px-9 wedocs-text-center wedocs-align-middle wedocs-shadow-xl wedocs-transition-all wedocs-overflow-visible">
                  ...
                  <div className="wedocs-relative wedocs-mt-6 wedocs-mb-5">
                    <input
                      type="text"
                      name="doc_title"
                      id="doc-title"
                  ...
                  <div className="wedocs-mt-6 wedocs-flex wedocs-items-center wedocs-justify-center wedocs-space-x-3.5">
                    ...
                    <div className={ `doc-publish-btn wedocs-group wedocs-relative` }>
                      ...
                      >
                      <span onClick={ () => docStatusHandler( 'draft' ) } className="wedocs-flex wedocs-items-center wedocs-py-2 wedocs-px-4 wedocs-text-sm wedocs-font-medium wedocs-text-gray-700 hover:wedocs-bg-indigo-700 hover:wedocs-text-white !wedocs-shadow-none">
                        { __( 'Create and Draft', 'wedocs' ) }
                      </span>
                        <span onClick={ () => docStatusHandler( 'publish' ) } className="wedocs-flex wedocs-items-center wedocs-py-2 wedocs-px-4 wedocs-text-sm wedocs-font-medium wedocs-text-gray-700 hover:wedocs-bg-indigo-700 hover:wedocs-text-white !wedocs-shadow-none">
