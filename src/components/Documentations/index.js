...
const Documentations = () => {
	...
	return (
		<>
			...
			>
				{ ! loading &&
                    filteredDocs.length > 0 && (
                        <DraggableDocs docs={ filteredDocs } docType={ 'Documentation' }>
            ...
            { ! loading && searchValue &&
                filteredDocs.length === 0 && (
                    <h2 className="float-left text-lg mt-4">{ __( 'Your searching documentation not available at this moment...', 'wedocs' ) }</h2>
                ) }
