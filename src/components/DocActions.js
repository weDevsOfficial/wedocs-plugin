...
const DocActions = ( { docId, addArticle = false } ) => {
  ...
  //
  //     console.log( actionDom, event.target );
  //
  //     if ( typeof actionDom !== 'undefined' ) {
  //       if ( ! actionDom?.contains( event.target ) ) {
  //         console.log( 'hello', showActions );
  //         setShowActions( false );
  //       }
  //     }
  //     // if ( actionDom !== null && ! actionDom?.contains( event.target ) ) {
  //     //   setShowActions( false );
  //     // }
  //   } );
  //   // }
  ...
  return (
    <>
      <div className="documentation-ellipsis-actions relative">
        ...
        { /*        >*/ }
        { /*          <Menu.Items*/ }
        { /*            className="!w-40 absolute right-0 z-10 mt-2 w-56 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"*/ }
        { /*            static={ true }*/ }
        { /*          >*/ }
        { /*            <div className="py-1">*/ }
        { /*              { addArticle && (*/ }
