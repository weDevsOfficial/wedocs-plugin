...
const Badge = ( { classes, position="relative" } ) => {
  ...
  return (
    <span
      ...
      className={ `${position} pro-badge cursor-pointer text-white text-[10px] py-[3px] px-[5px] leading-none ml-1.5 ${ classes ? classes : '' }` }
    >
