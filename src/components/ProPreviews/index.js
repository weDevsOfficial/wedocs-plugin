        ...
        function ( menus ) {
            menus.permission = {
                ...
                icon: (
                    <svg
                        ...
                        className="wedocs--ml-1 wedocs-mr-4 pro-settings"
                    >
            ...
            menus.assistant = {
                ...
                subtabs: [
                    {
                        pro: true,
                        text: __( 'A.I. Chat', 'wedocs' ),
                        icon: (
                            <svg width="20" height="16" fill="none" style={{ marginRight: '1em' }} className="wedocs--ml-1 wedocs-mr-4">
                    ...
                    {
                        pro: true,
                        text: __( 'Explore', 'wedocs' ),
                        icon: (
                            <svg width='20' height='20' fill='none' className="wedocs--ml-1 wedocs-mr-4">
                                <path
                                    strokeWidth='2'
                                    stroke='#6b7280'
                                    strokeLinecap='round'
                                    className="wedocs--ml-1 wedocs-mr-4"
                    ...
                    {
                        pro: true,
                        text: __( 'Messaging', 'wedocs' ),
                        icon: (
                            <svg width='20' height='16' fill='none' className="wedocs--ml-1 wedocs-mr-4">
                                <path
                    ...
                    {
                        pro: true,
                        text: __( 'Placement', 'wedocs' ),
                        icon: (
                            <svg width='20' height='14' fill='none' className='wedocs--ml-1 wedocs-mr-4'>
                                <path
                                    strokeWidth='2'
                                    stroke='#6b7280'
                                    strokeLinecap='round'
                    ...
                    {
                        pro: true,
                        text: __( 'Widget Preference', 'wedocs' ),
                        icon: (
                            <svg width='20' height='18' fill='none' className='wedocs--ml-1 wedocs-mr-4'>
                                <path
                                    strokeWidth='2'
                                    stroke='#6b7280'
                                    strokeLinecap='round'
            ...
            menus.styles = {
                ...
                icon: (
                    <svg
                        ...
                        stroke="#6b7280"
                        strokeLinejoin="round"
                        className="wedocs--ml-0.5 wedocs-mr-4 pro-settings"
                    >
                ...
                <>
                    { userIsAdmin() && (
                        <>
                            { type === 'doc' && (
                                <UpgradePopup>
                <span className="wedocs-group wedocs-flex wedocs-items-center wedocs-py-2 wedocs-px-4 wedocs-space-x- wedocs-text-sm wedocs-font-medium wedocs-text-gray-700 hover:wedocs-bg-gray-100 hover:wedocs-text-gray-900 !wedocs-shadow-none">
                  <span>{ __( 'Permission Management', 'wedocs' ) }</span>
                  <span className={ `crown wedocs-cursor-pointer wedocs-relative wedocs-text-white wedocs-text-[10px] wedocs-py-[3px] wedocs-px-[5px] wedocs-leading-none wedocs-ml-2.5` }>
                  ...
                  <span className='wedocs-ml-1 wedocs-text-white wedocs-bg-[#FF9000] wedocs-px-1.5 wedocs-py-0.5 wedocs-rounded wedocs-leading-[13.31px] wedocs-text-[11px] wedocs-pt-[1px] wedocs-pb-0.5 wedocs-px-[5px]'>
                    { __( 'Pro', 'wedocs' ) }
                  </span>
                </span>
                                </UpgradePopup>
                            ...
                            { type === 'article' && (
                                <UpgradePopup>
                <span className='wedocs-group wedocs-w-full wedocs-flex wedocs-items-center wedocs-py-2 wedocs-px-4 wedocs-space-x-2.5 wedocs-text-sm wedocs-font-medium wedocs-text-gray-700 hover:wedocs-bg-gray-100 hover:wedocs-text-gray-900 !wedocs-shadow-none'>
