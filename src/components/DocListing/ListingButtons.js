...
const ListingButtons = ({ sections }) => {
	...
	return (
		<div className="doc-listing-buttons space-x-3.5 mt-10">
			<AddSectionModal parent={ id } className="py-2.5 px-4 h-fit inline-flex items-center rounded-md border border-gray-300 bg-white text-gray-700 hover:text-white hover:bg-indigo-600 px-4 text-sm shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
