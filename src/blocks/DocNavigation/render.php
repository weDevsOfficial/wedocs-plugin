 ...
 */
if (!function_exists('render_wedocs_doc_navigation')) {
    ...
    // Handle custom border radius — always applied so rounded corners work without a visible border.
    if ($nav_border_radius && $nav_border_radius !== '0px') {
        $custom_nav_styles[] = sprintf(
            'border-radius: %s;',
