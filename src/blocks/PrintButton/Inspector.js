...
const Inspector = ({ attributes, setAttributes }) => {
    ...
    const updateAttribute = (attributeName, property = null) => (value) => {
        if (property) {
            setAttributes({
                [attributeName]: {
    ...
    return (
        <Fragment>
            <PanelBody title={__('Style Settings', 'wedocs')} initialOpen={false}>
                <SelectControl
                    label={__('Button Style', 'wedocs')}
                    value={attributes.buttonStyle}
                    options={[
                        { label: __('Primary', 'wedocs'), value: 'primary' },
                        { label: __('Secondary', 'wedocs'), value: 'secondary' },
                ...
                {BoxControl ? (
                    ...
                    <Fragment>
                        <p style={{ marginBottom: '16px', color: '#666' }}>
                            {__('Individual spacing controls (Padding & Margin)', 'wedocs')}
                        </p>
            ...
            <PanelBody title={__('Border & Typography', 'wedocs')} initialOpen={false}>
                {UnitControl ? (
                    <Fragment>
                        <UnitControl
                    ...
                    <Fragment>
                        <RangeControl
                            ...
                            onChange={(value) => updateAttribute('borderRadius')(`${value}px`)}
                            min={0}
                            max={50}
                        />
                        ...
                        <RangeControl
                            ...
                            onChange={(value) => updateAttribute('borderWidth')(`${value}px`)}
                            min={0}
                            max={10}
                        />
                        ...
                        <RangeControl
                            ...
                            onChange={(value) => updateAttribute('fontSize')(`${value}px`)}
                            min={10}
                            max={32}
                        />
                    </Fragment>
