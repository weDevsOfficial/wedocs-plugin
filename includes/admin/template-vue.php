        ...
        <li class="single-doc" v-for="(doc, index) in docs" :data-id="doc.post.id">
            <h3>
                ...
                <span class="wedocs-row-actions">
                    ...
                    <span class="wedocs-btn-remove" v-on:click="removeDoc(index, docs)" title="<?php esc_attr_e( 'Delete this doc', 'wedocs' ); ?>"><span class="dashicons dashicons-trash"></span></span>
                    ...
                    <li v-for="(section, index) in doc.child" :data-id="section.post.id">
                        <span class="section-title" v-on:click="toggleCollapse">
                            ...
                            <span class="actions wedocs-row-actions">
                                ...
                                <span class="wedocs-btn-remove" v-on:click="removeSection(index, doc.child)" title="<?php esc_attr_e( 'Delete this section', 'wedocs' ); ?>"><span class="dashicons dashicons-trash"></span></span>
                        ...
                        <ul class="articles collapsed connectedSortable" v-if="section.child" v-sortable>
                            <li class="article" v-for="(article, index) in section.child" :data-id="article.post.id">
                                ...
                                <span class="actions wedocs-row-actions">
                                    ...
                                    <span class="wedocs-btn-remove" v-on:click="removeArticle(index, section.child)" title="<?php esc_attr_e( 'Delete this article', 'wedocs' ); ?>"><span class="dashicons dashicons-trash"></span></span>
                                </span>
                            </li>
                        </ul>
                    </li>
